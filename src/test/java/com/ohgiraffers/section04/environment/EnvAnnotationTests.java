...
public class EnvAnnotationTests {
    ...
    @Test
    @EnabledOnOs(value = {OS.WINDOWS, OS.LINUX}, disabledReason = "윈도우와 리녹스만 테스트 합니다.")
     ...
     * (min 만 작성 시 min~최신버전까지, max만 작성시 이전 버전부터 max까지만 테스트를 합니다.)
     */
